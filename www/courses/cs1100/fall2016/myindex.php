<img src="images/textbooks.png" alt="" 
    class="float-left" style="width:180px;padding:5px;">
...
<aside class="aside1">
    <h5>Links</h5>
    <ul>
        <li><a href="syllabus-cs1100-fall2016.pdf">Syllabus</a>
...
<p> "Client-side code" refers to code that resides on the user's computer and runs in an Internet browser like Firefox, Chrome or Safari (i.e., the client), as opposed to "server-side code", which resides on the web server that hosts the website. 

<p>Although this course is only an introduction, you will be introduced to a lot of ideas and new skills. You will learn about core web technologies, how to display content on a web page - i.e., how to create simple websites with HTML and style them with CSS. You will also learn how to make that content "do" things  - i.e., how to write simple programs using JavaScript, how to use a JavaScript library like jQuery to create cool visual effects, and how to tap into public APIs (application programming interfaces) to add dynamic content and functionality to your own web pages.

<p>The course is for beginners: there are no prerequisites, no coding background is assumed. 
...
<table class="schedule days-3">
	...
	<tbody>
		...
		<tr>
			<td>Wed, 10/19
			<td>
			<td><a href="sessions/16_resources/slides16.pdf">Session 16: Conditional statements and functions (continued)</a>
